...
// Heurísticas idênticas às de listagem para manter consistência
...
export async function POST(request: NextRequest) {
  try {
    ...
    // 1. Atualiza o fipe_code na tabela do Supabase
    ...
    // 2. Processa o lead recém-atualizado para cotar e enriquecer em tempo real
    ...
    // Busca a FIPE pelo código selecionado
    // Primeiro tenta no cache local, depois online
    ...
    // Se achou a cotação, calcula deságio e Deal Score
    if (fipeMatch) {
