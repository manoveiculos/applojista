...
import { isVehicleOffer } from '@/lib/parser/classifier';
import { extractOffer } from '@/lib/parser/extractor';
import { calculateNetPrice, calculateFipePercent } from '@/lib/calc/net-price';
import { computeDealScore } from '@/lib/intel/deal-score';
